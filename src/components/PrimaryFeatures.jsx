...
const features = [
  ...
  },
  {
    ...
    description:
      "You can subscribe to managed-services at pisignage.com or use open-source server software to manage players",
    image: plDetails,
  },
  {
    title: 'Flexibility in sourcing content',
    description:
  ...
  {
    title: 'Offline working & fast sync',
    description:
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          <h2 className="font-display text-3xl tracking-tight text-white sm:text-4xl md:text-5xl">
            Everything you need to run your signage.
          </h2>
